...
@section('title', 'Novo Distribuidor')
            ...
            <div class="row">
                ...
                <div class="tab-pane fade" id="vendedores" role="tabpanel">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> <strong>Informação:</strong> Os vendedores serão adicionados após o cadastro do distribuidor na tela de detalhes.
                    </div>

                    <div id="vendedores-container">
                        <p class="text-muted text-center">Adicione vendedores vinculados a este distribuidor após salvar o cadastro.</p>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        // Carregar cidades já selecionadas (do old() do Laravel)
